            ...
            <div class="container pt-3">
                <div class="row g-0 pt-5">
                    <div class=" ps-5 pt-5 mt-5 col-lg-5 ">
                        <img src="images/custo.png" class="img-fluid">
                    </div>
                    <div class="col-lg-7 text-center py5">
                        ...
                        <form action="/cwh/Register.php" method="post">
                            ...
                            <div class="form-row pt-5 ">
                                <div  class="  offset-1 col-lg-10">
                                    <select  name="gender" class="inp px-3 form-selec op " aria-label="Default select example">
                                        <option class="op" selected>Select Gender</option>
                                        <option class="op" value="F">Female</option>
                                        <option class="op" value="M">Male</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-row pt-5 ">
